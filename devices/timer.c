...
static bool wakes_early_and_mvp_func(const struct list_elem* a, const struct list_elem* b, void* aux);
...
bool wakes_early_and_mvp_func(const struct list_elem* a, const struct list_elem* b, void* aux)
{
